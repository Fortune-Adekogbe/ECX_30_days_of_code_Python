...
def word_score(word):
    ...
    '''
    assert word.isalpha() , 'You have not entered a valid word'
    ...
    for ch in word.upper():
        score+=points[ch]
    return score
words = ['approval','zenith','special','development','govern','prioritize','trademark','inventory','penalty','Whimsical']
for word in words:
